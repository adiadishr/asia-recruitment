...
export default function Page() {
  ...
  return (<>
    ...
    <div className="w-[90%] md:w-[85%] container mx-auto py-20 md:pt-30">
      ...
      <div className="grid grid-cols-4 gap-5 sm:gap-15 md:gap-10">
    ...
    <div className="w-[90%] md:w-[85%] container mx-auto pb-20">
      ...
      <div className="grid md:grid-cols-2 gap-15 md:gap-20">
        <div className="relative p-10 overflow-hidden font-medium text-white md:pr-20 heading h-max rounded-2xl">
