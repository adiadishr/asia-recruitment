...
export const Timeline = ({
    ...
    return (
        (<div
            ...
            <div ref={ref} className="relative md:mt-[-2rem]">
                {data.map((item, index) => (
                    <div key={index} className="flex justify-start pt-10 first:pt-20 md:pt-20 md:gap-10">
                        <div
                ...
                <div
                    ...
                    <motion.div
                        ...
                        className="absolute inset-x-0 top-0  w-[1px] bg-gradient-to-t from-orange-400/50 via-yellow-400/30 to-transparent rounded-b-full" />
                </div>
            </div>
        </div>)
    );
