...
export default function FAQ({ className }) {
    return (<>
        {/* FAQ */}
        <div className={cn("py-20 w-[90%] mx-auto", className)} >
            <div className="mb-8 text-3xl tracking-tight text-center">Frequently Asked Questions</div>
            <Accordion type="multiple" collapsible="true" defaultValue={['item-1', 'item-2', 'item-3']} className="w-full md:w-[90%] mx-auto mb-8">
